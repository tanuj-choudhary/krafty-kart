...
export default function ProductDetail({ product,handleCartClick }) {
  ...
  const renderProduct = () => {
    ...
    return <Container className="product-detail-container mb-20">
    <Row>
      <Col md={6} lg={5}>
        <figure className="product-image mb-10">
          <Image className="product-main-image" src={product.url} />
        </figure>
      </Col>
      <Col md={6} lg={7}>
        <div className="product-details">
          ...
          <div className="product-price mb-13">{product.price}</div>
          ...
          <div className="product-detail-action">
            <Button onClick={handleCartClick} className="add-cart-btn py-10 px-15">
